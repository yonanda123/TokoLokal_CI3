...
class Lendingmodel extends CI_Model {
     ...
     */
    const TABLE_NAME = 'tb_lending';

    /**
     * @name string PRI_INDEX Holds the name of the tables' primary index used in this model
     */
    const PRI_INDEX = 'lending_no';
   ...
   /**
    * get total dari yang di lending-kan
    *
    * @return void
    * @author Ayatulloh Ahad Robanie [ayatulloh@idprogrammer.com]
    **/
    public function totalLendingAmount( $userid = null )
    {
        ...
        if ( $get != false ){
            ...
            foreach ($get as $value) {
                $amount = $amount + $value->lending_amount;
            }
     ...
     * @author Ayatulloh Ahad Robanie [ayatulloh@idprogrammer.com]
     **/
    public function activeLending( $userid = null )
    {
