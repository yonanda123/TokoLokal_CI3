                            ...
                            <div id="lg1" class="tab-pane active">
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <?php echo form_open('', 'class="login-register-form"'); ?>
                                        <input name="authentication_id" type="text" class="form-control" placeholder="Username" autocomplete="off" onkeypress="return RestrictSpace()" />
                                        <input name="authentication_password" type="password" class="form-control" placeholder="Kata Sandi" autocomplete="off" onkeypress="return RestrictSpace()" />     
                                            <div class="button-box">
                                                <button type="submit"  id="btnmasuk" style="width: 100%;border-radius: 2px;">MASUK</button>
                                                <button type="button"  id="btnloading" disabled style="width: 100%;border-radius: 2px;"><i class="fa fa-spinner fa-pulse"></i> PROSES MASUK</button>
                                            </div>
                                        <?php echo form_close(); ?>
                                    </div>
                                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-3 col-12">
                        <div class="payment-mathod pb-20">
                            <a href="#"><img src="assets/frontend/img/icon-img/payment.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
