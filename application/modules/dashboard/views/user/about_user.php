    ...
    <div class="about-story-area pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="story-img">
                        <a href="#"><img src="assets/frontend/img/banner/banner-16.png" alt=""></a>
                ...
                <div class="col-lg-6">
                    <div class="story-details pl-50">
                        <div class="story-details-top">
                            <h2>WELCOME TO <span>TOKO LOKAL!</span></h2>
                        ...
                        <div class="story-details-bottom">
                            <h4>WIN BEST ONLINE SHOP AT 2066</h4>
                            <p>Parlo provide how all this mistaken idea of denouncing pleasure and sing pain was born an will give you a complete account of the system, and expound the actual teachings of the eat explorer. </p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single-banner mb-30 scroll-zoom">
                        <a href="#"><img class="animated" src="assets/frontend/img/banner/banner-9.png" alt=""></a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single-banner mb-30 text-center scroll-zoom">
                        <a href="#"><img class="animated" src="assets/frontend/img/banner/banner-10.png" alt=""></a>
    ...
    <div class="testimonial-area pt-80 pb-95 section-margin-1" style="background-image: url(assets/frontend/img/bg/bg-1.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 ml-auto mr-auto">
                    <div class="testimonial-active owl-carousel nav-style-1">
                        <div class="single-testimonial text-center">
                            <img src="assets/frontend/img/testimonial/testi-1.png" alt="">
                            ...
                            <div class="client-info">
                                <img src="assets/frontend/img/icon-img/testi.png" alt="">
                                <h5>Nikolas Dehlli</h5>
                            </div>
                        </div>
                        <div class="single-testimonial text-center">
                            <img src="assets/frontend/img/testimonial/testi-2.png" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <a href="#">
                                <img src="assets/frontend/img/team/team-3.jpg" alt="">
                            </a>
                            <div class="team-action">
                                <a class="facebook" href="#">
                                    <i class="sli sli-social-facebook"></i>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <a href="#">
                                <img src="assets/frontend/img/team/team-2.jpg" alt="">
                            </a>
                            <div class="team-action">
                                <a class="facebook" href="#">
                                    <i class="sli sli-social-facebook"></i>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <a href="#">
                                <img src="assets/frontend/img/team/team-4.jpg" alt="">
                            </a>
                            <div class="team-action">
                                <a class="facebook" href="#">
                                    <i class="sli sli-social-facebook"></i>
