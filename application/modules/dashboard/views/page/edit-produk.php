...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control form-control-rounded form-control-solid" name="produk_nama" n />
        </div>
        <div class="form-group">
            ...
            <textarea id="textarea" name="produk_deskripsi" rows="20" value="<?php echo $produk->produk_deskripsi ?>"></textarea>
        </div>
        <div class="form-group">
